...
{
    [self WSSSpaceAtDistance:kWSSStandardSpace
   fromSuperviewInDirections:directions];
}
        ...
        fromSuperviewInDirections:(WSSConstraintDirection)directions
{
    ...
    if( directions & WSSConstraintDirectionHorizontal ){
        ...
        horizFormat = [NSString stringWithFormat:@"H:%@[view]%@",
                       leftEdge, rightEdge];
    }
    ...
    if( directions & WSSConstraintDirectionVertical ){
        ...
        vertFormat = [NSString stringWithFormat:@"V:%@[view]%@", topEdge,
                      bottomEdge];
    }
...
- (void)WSSCenterInSuperviewInDirections:(WSSConstraintDirection)directions
{
    NSAssert(directions == WSSConstraintDirectionHorizontal ||
             ...
             @"Direction for centering must be one or both of "
              "WSSConstraintDirectionHorizontal and "
